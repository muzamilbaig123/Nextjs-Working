        ...
        <>
            <>
                <div style={{ width: "100%", height: "100vh", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
                    ...
                    <h1 style={{ fontWeight: "900", fontSize: "34px" }} className="mt-10">React</h1>
                    <p style={{ fontWeight: "600", fontSize: "20px" }} className="mt-10">The library for web and native user interfaces</p>
                    <div className="mt-10">
                        <button style={{ backgroundColor: "blue", color: "white", padding: "6px 18px" }} className="rounded" >Learn React</button>
